    ...
    public class ProductController : Controller
    {
        ...
        public async Task<IActionResult> Upsert(int? id)
        {
            ...
            ProductVM productVM = new ProductVM()
            {
                ...
                ApplicationTypeList = _unitOfWork.ApplicationType.GetAll().Select(i => new SelectListItem
                {
                    Text = i.Name,
                    Value = i.Id.ToString()
                })
        ...
        public async Task<IActionResult> Upsert(ProductVM productVM)
        {
            ...
            else
            {
                ...
                productVM.ApplicationTypeList = _unitOfWork.ApplicationType.GetAll().Select(i => new SelectListItem
                {
                    Text = i.Name,
                    Value = i.Id.ToString()
                });
        ...
        {
            var allObj = _unitOfWork.Product.GetAll(includeProperties: "Category,ApplicationType");
