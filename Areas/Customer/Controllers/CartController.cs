...
using MachineApp.Models.ViewModels;
...
namespace MachineApp.Areas.Customer.Controllers
{
    [Area("Customer")]
    public class CartController : Controller
    {
        ...
        public async Task<IActionResult> IndexPOST()
        {
            ...
            if (user == null)
            {
                ModelState.AddModelError(string.Empty, "Verifierings-e-postmeddelandet är tomt!");
            }
            ...
            await _emailSender.SendEmailAsync(user.Email, "Bekräfta din E-Post",
                $"Bekräfta ditt konto genom att<a href='{HtmlEncoder.Default.Encode(callbackUrl)}'>klicka här</a>.");

            ModelState.AddModelError(string.Empty, "Verifierings-e-post skickat. Kontrollera din e-post.");
